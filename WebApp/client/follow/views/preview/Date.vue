...
export default {
  ...
  methods: {
    ...
    handleChange () {
      let arr = []
      if (this.yearState) arr.push(this.handleVal(this.year))
      if (this.monthState) arr.push(this.handleVal(this.month))
      if (this.dayState) arr.push(this.handleVal(this.day))
      let str = arr.join('-')
      this.$emit('input', str)
