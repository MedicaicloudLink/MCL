    ...
    <up-refresh :elheight="tableHeight" @isdown="getCaseList">
      <div class="table-body">
        ...
        <div class="empty" v-if="empty">
          <img src="../../assets/empty/save.png" alt="medicayun">
        </div> 
      </div>
    </up-refresh>
	</div>
...
export default {
  ...
  methods: {
    getCaseList () {
      this.$http.GetFollowStateList({userid: this.$root.userid, projectid: this.projectid, pagenum: this.pagenum, type: 'save'}).then(rep => {
