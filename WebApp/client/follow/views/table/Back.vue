...
export default {
  ...
  methods: {
    getCaseList () {
      this.$http.GetFollowStateList({userid: this.$root.userid, projectid: this.projectid, pagenum: this.pagenum, type: 'return'}).then(rep => {
