  ...
  <div class="count flex-row">
    ...
    <up-refresh :elheight="tableHeight - 20" @isdown="getWorkData">
      <div class="table-body">
        <div class="table-tr flex-row"  v-for="item in workDataList" :key="item.mdid">
          <span class="w14">
            <router-link :to="{name: 'workdata-record', params: {mdid: item.mdid}, query: {redirct: 'workdata'}}">{{ item.u_patientname }}</router-link>
          </span>
