<template>
  <div id="header">
    <div class="left">
      ...
      <router-link class="product" to="/home" tag="span">梅地卡尔临床数据云</router-link>
    </div>
    <div class="right">
      <a href="/user/notice">
    ...
    <popover ref="config" class="config flex-col">
      ...
      <div class="link-list flex-col">
        <router-link to="/profile" class="link-item">用户设置</router-link>
        <router-link to="/profile" class="link-item">用户帮助</router-link>
      </div>
    ...
    methods: {
      ...
      exit () {
        ...
        if (process.env.NODE_ENV === 'development') {
          ...
          window.location.href = window.location.origin + '/login/loginform?redirect=site'
        }
      }
    }
  }
