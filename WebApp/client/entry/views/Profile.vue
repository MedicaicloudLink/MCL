  ...
  <div id="userInfo">
    <div class="content flex-row">
      <div class="profile">
        <div class="user-info">
          <div class="avatar">
            ...
            <span v-else><img :src="'http://' + $root.avatar" alt="" class="avatar-img"></span>
          </div>
      ...
      <div class="config">
        ...
        <div class="option flex-row">
          <label style="width: 120px;">科室</label>
          <div class="flex-col">
            <div class="flex-row between center">
  ...
  export default {
    ...
    methods: {
      ...
      saveInfo (changId) {
        ...
        this.$http.SetUserinfo({userInfo: JSON.stringify(data)}).then(response => {
          this.toast({
            text: '修改成功',
            type: 'success',
          ...
          this.state[changId] = false
          this.userInfo[changId] = this.editInfo[changId]
        }).catch(err => {
          this.toast({
            text: '保存失败，重新提交试试',
            type: 'success',
